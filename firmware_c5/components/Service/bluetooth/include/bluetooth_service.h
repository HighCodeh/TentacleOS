...
/**
 * @brief Initialize the BLE subsystem. Does not start the host task.
 *
 ...
 *
 * @return ESP_OK on success, ESP_ERR_TIMEOUT if sync fails.
 */
...
/**
 * @brief Start passive BLE sniffer (raw advertisement capture).
 *
...
/**
 * @brief Start BLE advertising with the configured device name.
 *
 * @return ESP_OK on success, or an error code.
 */
