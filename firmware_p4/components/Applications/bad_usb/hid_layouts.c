...
static const hid_key_entry_t s_ascii_us[128] = {
    ...
    ['-'] = {HID_KEY_MINUS, 0, 0, 0},     ['_'] = {HID_KEY_MINUS, MOD_SHIFT, 0, 0},
    ['='] = {HID_KEY_EQUAL, 0, 0, 0},     ['+'] = {HID_KEY_EQUAL, MOD_SHIFT, 0, 0},
    ['.'] = {HID_KEY_PERIOD, 0, 0, 0},    [','] = {HID_KEY_COMMA, 0, 0, 0},
    ['/'] = {HID_KEY_SLASH, 0, 0, 0},     ['?'] = {HID_KEY_SLASH, MOD_SHIFT, 0, 0},
    [';'] = {HID_KEY_SEMICOLON, 0, 0, 0}, [':'] = {HID_KEY_SEMICOLON, MOD_SHIFT, 0, 0},
};
...
static const hid_key_entry_t s_ascii_abnt2[128] = {
    ...
    ['A'] = {HID_KEY_A, MOD_SHIFT, 0, 0},
    ['B'] = {HID_KEY_B, MOD_SHIFT, 0, 0},
    ['C'] = {HID_KEY_C, MOD_SHIFT, 0, 0},
    ['D'] = {HID_KEY_D, MOD_SHIFT, 0, 0},
    ['E'] = {HID_KEY_E, MOD_SHIFT, 0, 0},
    ['F'] = {HID_KEY_F, MOD_SHIFT, 0, 0},
    ['G'] = {HID_KEY_G, MOD_SHIFT, 0, 0},
    ['H'] = {HID_KEY_H, MOD_SHIFT, 0, 0},
    ['I'] = {HID_KEY_I, MOD_SHIFT, 0, 0},
    ['J'] = {HID_KEY_J, MOD_SHIFT, 0, 0},
    ['K'] = {HID_KEY_K, MOD_SHIFT, 0, 0},
    ['L'] = {HID_KEY_L, MOD_SHIFT, 0, 0},
    ['M'] = {HID_KEY_M, MOD_SHIFT, 0, 0},
    ['N'] = {HID_KEY_N, MOD_SHIFT, 0, 0},
    ['O'] = {HID_KEY_O, MOD_SHIFT, 0, 0},
    ['P'] = {HID_KEY_P, MOD_SHIFT, 0, 0},
    ['Q'] = {HID_KEY_Q, MOD_SHIFT, 0, 0},
    ['R'] = {HID_KEY_R, MOD_SHIFT, 0, 0},
    ['S'] = {HID_KEY_S, MOD_SHIFT, 0, 0},
    ['T'] = {HID_KEY_T, MOD_SHIFT, 0, 0},
    ['U'] = {HID_KEY_U, MOD_SHIFT, 0, 0},
    ['V'] = {HID_KEY_V, MOD_SHIFT, 0, 0},
    ['W'] = {HID_KEY_W, MOD_SHIFT, 0, 0},
    ['X'] = {HID_KEY_X, MOD_SHIFT, 0, 0},
    ['Y'] = {HID_KEY_Y, MOD_SHIFT, 0, 0},
    ['Z'] = {HID_KEY_Z, MOD_SHIFT, 0, 0},
    ...
    ['!'] = {HID_KEY_1, MOD_SHIFT, 0, 0},
    ['@'] = {HID_KEY_2, MOD_SHIFT, 0, 0},
    ['#'] = {HID_KEY_3, MOD_SHIFT, 0, 0},
    ['$'] = {HID_KEY_4, MOD_SHIFT, 0, 0},
    ['%'] = {HID_KEY_5, MOD_SHIFT, 0, 0},
    ['&'] = {HID_KEY_7, MOD_SHIFT, 0, 0},
    ['*'] = {HID_KEY_8, MOD_SHIFT, 0, 0},
    ['('] = {HID_KEY_9, MOD_SHIFT, 0, 0},
...
static const hid_layout_t s_layouts[DUCKY_LAYOUT_COUNT] = {
    ...
    [DUCKY_LAYOUT_ABNT2] = {s_ascii_abnt2,
                            s_utf8_abnt2,
