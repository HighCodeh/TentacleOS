...
static const uint8_t s_builtin_keys[][6] = {
    ...
    { 0xC3, 0x4B, 0xF0, 0x36, 0x40, 0x15 },
    { 0x9A, 0xB3, 0x45, 0x67, 0xAB, 0x34 },
    { 0x23, 0x40, 0x4E, 0x30, 0xD3, 0x4A },
    { 0x19, 0x74, 0x97, 0xC1, 0xC9, 0x31 },
    { 0xAC, 0xDD, 0xEB, 0xC3, 0x9C, 0x03 },
    { 0xEA, 0x64, 0x67, 0x23, 0xA9, 0x00 },
    { 0x21, 0x4F, 0x17, 0x39, 0x5B, 0x10 },
    { 0x11, 0x49, 0x7C, 0x33, 0xAF, 0xE2 },
    { 0x49, 0x46, 0x34, 0x34, 0x76, 0x41 },
    { 0x31, 0x45, 0x56, 0x41, 0x4F, 0x3A },
    { 0x1A, 0x2B, 0x3C, 0x4D, 0x5E, 0x6F },
    { 0xE9, 0x82, 0x4F, 0x4A, 0x2E, 0x4C },
    { 0xD7, 0x93, 0xA7, 0x52, 0xA8, 0xB7 },
    { 0x34, 0xEE, 0xF6, 0x14, 0xCE, 0x3A },
    { 0xFF, 0x00, 0xFF, 0x00, 0xFF, 0x00 },
    { 0x00, 0xFF, 0x00, 0xFF, 0x00, 0xFF },
    { 0x12, 0x34, 0x56, 0x78, 0x9A, 0xBC },
    { 0xAB, 0xCD, 0xEF, 0x12, 0x34, 0x56 },
    { 0xDE, 0xAD, 0xBE, 0xEF, 0xCA, 0xFE },
    { 0xFA, 0xCE, 0xB0, 0x07, 0x13, 0x37 },
    { 0x4A, 0x6F, 0x68, 0x6E, 0x57, 0x69 },
    { 0x6B, 0x65, 0x79, 0x31, 0x32, 0x33 },
    { 0x87, 0x3E, 0x1A, 0xCF, 0x5A, 0xA3 },
    { 0xF3, 0x21, 0x72, 0xE9, 0x89, 0x2E },
    { 0x40, 0xA8, 0xE0, 0x00, 0x00, 0x00 },
    { 0xBE, 0x6A, 0x60, 0x14, 0x96, 0x3B },
    { 0xD2, 0xBA, 0x54, 0x79, 0xE1, 0x28 },
    { 0x8E, 0x51, 0x7E, 0x70, 0xF7, 0x58 },
    { 0x61, 0xDA, 0x06, 0xA0, 0x55, 0xDE },
    { 0x37, 0x06, 0x58, 0x7C, 0xD9, 0x36 },
    { 0x29, 0xD2, 0x41, 0x42, 0xDA, 0x17 },
    { 0x57, 0x27, 0x29, 0xB2, 0x7E, 0x67 },
    { 0x52, 0x27, 0x57, 0xC1, 0xB2, 0xA1 },
    { 0x83, 0x4B, 0x03, 0x27, 0xB6, 0xAF },
    { 0x28, 0x7E, 0xC5, 0x65, 0xFF, 0x5C },
    { 0x1C, 0x0E, 0xB4, 0xC7, 0x38, 0xA3 },
    { 0x4E, 0xE4, 0x82, 0xC5, 0xF3, 0xC5 },
    { 0x12, 0x21, 0xB4, 0x32, 0x11, 0xD4 },
    { 0x96, 0x31, 0x43, 0x04, 0x5A, 0x8C },
    { 0x1B, 0x75, 0x5D, 0x87, 0x61, 0xA0 },
    { 0x3B, 0x1C, 0x3B, 0x55, 0x34, 0x88 },
    { 0x88, 0x44, 0x40, 0x13, 0x9C, 0x22 },
    { 0xA3, 0xDA, 0xCC, 0x68, 0x98, 0xA3 },
    { 0x8D, 0xD4, 0x0D, 0x2A, 0x91, 0x57 },
    { 0x27, 0x05, 0x67, 0x3B, 0x77, 0x84 },
    { 0x60, 0x90, 0x6C, 0x78, 0x68, 0x73 },
    ...
    { 0xC3, 0x7A, 0xC4, 0x3D, 0xA1, 0x00 },
    { 0x9C, 0x46, 0x14, 0x0A, 0xA6, 0xB2 },
    { 0x48, 0x62, 0xCF, 0x60, 0xED, 0x62 },
    { 0x08, 0xB9, 0xE7, 0xB2, 0xA6, 0x6B },
    { 0xF1, 0x22, 0xD7, 0x3B, 0x00, 0x48 },
    { 0x14, 0x17, 0x37, 0x23, 0x02, 0x4A },
    { 0x0C, 0xF1, 0x2A, 0x80, 0xF5, 0x4A },
    { 0xD3, 0xC4, 0xFE, 0x46, 0xA0, 0x3B },
    { 0x36, 0x25, 0x95, 0x36, 0x98, 0xDA },
    { 0xB8, 0xD9, 0xA6, 0x0E, 0x27, 0x4A },
    { 0x7E, 0x85, 0x45, 0xCD, 0x23, 0xE4 },
};

const int MF_KEY_DICT_BUILTIN_COUNT =
    (int)(sizeof(s_builtin_keys) / sizeof(s_builtin_keys[0]));
