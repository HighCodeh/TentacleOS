...
/**
 * @brief Format the card as exFAT specifically (TentacleOS addition).
 *
 * Same as esp_vfs_fat_sdcard_format() but forces FM_EXFAT instead of FM_ANY, so
 * even a small card that FM_ANY would make FAT32 is written as exFAT. Requires
 * FF_FS_EXFAT == 1 (see this vendored component's README).
 */
